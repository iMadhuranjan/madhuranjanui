export function SkeletonWithAvatar() {
  return (
    <div className="space-y-4 p-4 max-w-md w-full mx-auto">
      ...
      <div className="w-full h-48 bg-gray-300 dark:bg-gray-700 rounded-lg animate-pulse"></div>
...
export function VideoSkeleton() {
  return (
    <div className="p-5 flex justify-center items-center">
      <div
        role="status"
        className="flex items-center justify-center h-56 w-full max-w-md bg-gray-300 rounded-lg animate-pulse dark:bg-gray-700"
      >
        <svg
...
export function TextCloudSkeleton() {
  return (
...
export function ProfileCardSkeleton() {
  return (
    <div className="flex justify-center items-center p-5">
        <div
      role="status"
      className="w-full max-w-sm p-4 border border-gray-200 rounded-lg shadow animate-pulse dark:bg-gray-800 dark:border-gray-700"
    >
      ...
      <div className="h-3 bg-gray-200 rounded w-5/6 mb-2 dark:bg-gray-700"></div>
