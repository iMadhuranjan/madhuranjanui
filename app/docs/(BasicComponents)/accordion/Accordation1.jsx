...
export default function FlowbiteTailwindAlwaysCode({ code, children }) {
  ...
  return (
    ...
    <div className="my-3 md:my-5 border border-gray-200 dark:border-gray-700 rounded shadow overflow-hidden mx-auto w-full flex-1 transition-colors duration-300 ">
      ...
      <div className="w-full flex justify-center bg-gray-50 dark:bg-gray-800 transition-colors duration-300">
        <div className="overflow-x-auto w-full">
          <div
            className={`${deviceWidthClass[device]} h-fit py-5  mx-auto 
      ...
      <div className="relative w-full bg-gray-50 dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700 transition-colors duration-300 ">
        ...
        <div className="overflow-x-auto pt-8">
          <SyntaxHighlighter
            ...
            codeTagProps={{
              style: { userSelect: "text" }, // Allows code selection without numbers
            }}
            lineNumberStyle={{
              userSelect: "none", // Prevents line numbers from being copied
              pointerEvents: "none", // Stops them from being interacted with
              color: "#888", // Subtle color for line numbers
            }}
          >
            {displayedCode}
          </SyntaxHighlighter>
