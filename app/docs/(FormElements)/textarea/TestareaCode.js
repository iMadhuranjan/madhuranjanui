export const SimpleTextAreacode=`<div class="w-full max-w-md">
  <label
    for="message"
  ...
  <textarea
    ...
    class="block w-full rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 px-4 py-2 text-sm text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-violet-500 dark:focus:ring-blue-500 focus:border-transparent resize-y"
  ></textarea>
</div>
`

export const CommentTextareaCode=`<div class="max-w-lg mx-auto p-4 bg-white dark:bg-black shadow rounded">
      <label for="comment" class="block text-gray-900 dark:text-gray-100 text-sm font-medium mb-2">
        Your Comment
      </label>
      <textarea
        id="comment"
    ...
    export const COloredTextareaCode=`<div class="flex justify-center items-center p-2 md:p-5">
  <div class="flex w-96 flex-col gap-6 justify-center itce">
  <!-- Variant 1: Textarea Gray -->
  <div class="relative w-full min-w-[200px]">
    <textarea class="peer border-blue-gray-200 text-blue-gray-700 placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 disabled:bg-blue-gray-50 h-full min-h-[100px] w-full resize-none rounded-[7px] border border-t-transparent bg-transparent px-3 py-2.5 font-sans text-sm font-normal outline-0 transition-all placeholder-shown:border focus:border-2 focus:border-gray-900 focus:border-t-transparent focus:outline-0 disabled:resize-none disabled:border-0" placeholder=" "></textarea>
  ...
  <div class="flex flex-col gap-6 w-96">
    ...
    <div class="relative w-full">
      ...
      <label for="disabled-textarea"
        class="absolute left-3 top-2 text-[11px] font-normal text-blue-gray-400 transition-all">
        Disabled Textarea
      </label>
    </div>
  </div>
...
export const TextareaWithAvatarAndActionCode=`<div class="flex flex-col p-4 max-w-2xl mx-auto bg-white dark:bg-gray-800 shadow-lg  transition-colors rounded-sm duration-200">
  <!-- Top Section: Avatar & Textarea -->
  <div class="flex space-x-3">
    <img class="w-11 h-11 rounded-full flex-shrink-0 object-cover" src="https://via.placeholder.com/44" alt="User avatar">
    <textarea
      class="w-full bg-transparent text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 border-none focus:outline-none resize-none text-lg leading-relaxed"
  ...
  <div class="flex items-center justify-between mt-3 pt-3 border-t border-gray-200 dark:border-gray-700">
    <div class="flex space-x-1">
      <!-- Media Button -->
      <button type="button" class="p-2 rounded-full text-blue-500 hover:bg-blue-50 dark:hover:bg-blue-900/30 transition-colors duration-150" title="Media">
      ...
      <!-- GIF Button -->
      <button type="button" class="p-2 rounded-full text-green-500 hover:bg-green-50 dark:hover:bg-green-900/30 transition-colors duration-150" title="GIF">
        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
      ...
      <!-- Poll Button -->
      <button type="button" class="p-2 rounded-full text-purple-500 hover:bg-purple-50 dark:hover:bg-purple-900/30 transition-colors duration-150" title="Poll">
        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
      ...
      <!-- Emoji Button -->
      <button type="button" class="p-2 rounded-full text-yellow-500 hover:bg-yellow-50 dark:hover:bg-yellow-900/30 transition-colors duration-150" title="Emoji">
        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
      ...
      <!-- Schedule Button -->
      <button type="button" class="p-2 rounded-full text-pink-500 hover:bg-pink-50 dark:hover:bg-pink-900/30 transition-colors duration-150" title="Schedule">
        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
          <path d="M12 2C6.486 2 2 6.486 2 12s4.486 10 10 10 10-4.486 10-10S17.514 2 12 2zm0 18c-4.411 0-8-3.589-8-8s3.589-8 8-8 8 3.589 8 8-3.589 8-8 8z"/>
    ...
    <button 
      type="button" 
      class="bg-blue-500 hover:bg-blue-600 dark:bg-blue-600 dark:hover:bg-blue-700 text-white font-semibold py-1.5 px-4 rounded-full transition-colors duration-200 disabled:opacity-50"
...
export const ChatInputTextareaCode=` <div class="bg-gray-800/95 dark:bg-gray-900/95 backdrop-blur-sm p-4 w-full border-t border-gray-700 dark:border-gray-800">
   <div class="flex items-end space-x-2 bg-gray-700/80 dark:bg-gray-800/80 rounded-xl px-3 py-2 ring-1 ring-gray-600/30 dark:ring-gray-700/50 focus-within:ring-2 focus-within:ring-blue-500/50 transition-all duration-200">
     <button type="button" class="p-2 rounded-lg text-gray-400 hover:text-gray-200 hover:bg-gray-600/50 dark:hover:bg-gray-700/50 transition-all" aria-label="Emoji">
      <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
        <path d="M12 2C6.486 2 2 6.486 2 12s4.486 10 10 10 10-4.486 10-10S17.514 2 12 2zm0 18c-4.411 0-8-3.589-8-8s3.589-8 8-8 8 3.589 8 8-3.589 8-8 8z"/>
        <path d="M14.829 14.828a4.055 4.055 0 0 1-1.272.858 4.002 4.002 0 0 1-4.875-1.45l-1.658 1.119a6.063 6.063 0 0 0 1.621 1.62 5.963 5.963 0 0 0 2.148.903 6.042 6.042 0 0 0 3.542-.35 6.048 6.048 0 0 0 1.907-1.284c.181-.179.362-.358.536-.542l-1.658-1.119a4.017 4.017 0 0 1-.489.591z"/>
        <circle cx="8.5" cy="10.5" r="1.5"/>
     ...
     <button type="button" class="p-2 rounded-lg text-gray-400 hover:text-gray-200 hover:bg-gray-600/50 dark:hover:bg-gray-700/50 transition-all" aria-label="Attach file">
      <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
     ...
     <textarea
      ...
      class="flex-1 max-h-32 bg-transparent text-gray-200 placeholder-gray-500 dark:placeholder-gray-400 outline-none resize-none px-2 py-2 scrollbar-thin scrollbar-thumb-gray-600 scrollbar-track-transparent"
    ></textarea>

     <button type="button" class="p-2 rounded-lg text-blue-400 hover:text-blue-300 hover:bg-blue-500/10 transition-all disabled:opacity-40 disabled:hover:bg-transparent" aria-label="Send message" disabled>
      <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
